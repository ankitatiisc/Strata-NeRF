...
def transform_poses_pca(poses: np.ndarray, cube_normalization:bool=True) -> Tuple[np.ndarray, np.ndarray]:
...
def cast_ray_batch(
  ...
  return utils.Rays(
      ...
      camera_level = pixels.camera_level,
